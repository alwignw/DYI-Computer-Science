https://csrc.nist.gov/glossary?page=1


**Slowloris** adalah alat dan teknik serangan Denial-of-Service (DDoS) yang memungkinkan satu komputer melumpuhkan server web lain dengan mengirimkan permintaan HTTP secara lambat namun terus-menerus


**SCSI** (dibaca skuzi) adalah singkatan dari Small Computer System Interface. Secara teknis, ini adalah seperangkat standar antarmuka dan protokol komunikasi yang digunakan untuk menghubungkan komputer dengan perangkat periferal (seperti hard disk, tape drive, pemindai, atau printer) agar dapat mentransfer data dengan kecepatan tinggi.
